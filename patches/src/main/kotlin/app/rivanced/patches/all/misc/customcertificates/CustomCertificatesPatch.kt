package app.rivanced.patches.all.misc.customcertificates
...
val customNetworkSecurityPatch = resourcePatch(
    ...
    val allowCleartextTraffic by booleanOption(
        key = "Allow cleartext traffic (HTTP)",
    ...
    val overridePins by booleanOption(
        key = "Override certificate pinning",
