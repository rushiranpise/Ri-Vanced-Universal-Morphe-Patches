package app.rivanced.patches.all.misc.directory.documentsprovider
...
val exportInternalDataDocumentsProviderPatch = resourcePatch(
    ...
    dependsOn(
        bytecodePatch {
            extendWith("extensions/all/misc/directory/documentsprovider/export-internal-data-documents-provider.mpe")
        },
    )

    execute {
        val documentsProviderClass =
            "app.morphe.extension.all.misc.directory.documentsprovider.InternalDataDocumentsProvider"
