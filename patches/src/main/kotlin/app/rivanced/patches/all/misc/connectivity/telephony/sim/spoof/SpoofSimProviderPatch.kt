package app.rivanced.patches.all.misc.connectivity.telephony.sim.spoof

import app.morphe.patcher.util.proxy.mutableTypes.MutableMethod
import app.rivanced.patcher.extensions.getInstruction
import app.rivanced.patcher.extensions.replaceInstruction
...
@Suppress("unused")
val spoofSIMProviderPatch = bytecodePatch("Spoof SIM provider", "Spoofs information about the SIM card provider.", false) {
    ...
    val networkOperator by intOption(
        key = "MCC+MNC network operator code",
