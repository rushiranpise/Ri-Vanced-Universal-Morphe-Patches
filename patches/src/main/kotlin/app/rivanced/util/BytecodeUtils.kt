...
import app.rivanced.patcher.MutablePredicateList
import app.rivanced.patcher.classDef
import app.rivanced.patcher.custom
import app.morphe.patcher.util.smali.ExternalLabel
import app.rivanced.patcher.extensions.addInstruction
import app.rivanced.patcher.extensions.addInstructions
import app.rivanced.patcher.extensions.addInstructionsWithLabels
import app.rivanced.patcher.extensions.fieldReference
import app.rivanced.patcher.extensions.getInstruction
import app.rivanced.patcher.extensions.instructions
import app.rivanced.patcher.extensions.instructionsOrNull
import app.rivanced.patcher.extensions.methodReference
import app.rivanced.patcher.extensions.removeInstruction
import app.rivanced.patcher.classDefs
import app.rivanced.patcher.extensions.stringReference
import app.rivanced.patcher.firstClassDef
import app.rivanced.patcher.firstClassDefOrNull
import app.rivanced.patcher.firstMethod
import app.rivanced.patcher.immutableClassDef
...
// https://github.com/BiliRoamingX/BiliRoamingX/blob/ae58109f3acdd53ec2d2b3fb439c2a2ef1886221/patches/src/main/kotlin/app/morphe/patches/bilibili/utils/Extenstions.kt#L51
/**
 * Additional registers effectively take the place of the pX parameters (p0, p1, p2, etc.)
 * and contain the original contents of the method parameters.
 * Added registers always start at index: `originalMethod.implementation!!.registerCount` of the
