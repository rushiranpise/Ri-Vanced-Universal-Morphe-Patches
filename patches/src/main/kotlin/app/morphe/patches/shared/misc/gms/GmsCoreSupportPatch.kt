...
import app.morphe.patcher.extensions.string
...
import app.morphe.patches.shared.misc.gms.Constants.APP_AUTHORITIES
import app.morphe.patches.shared.misc.gms.Constants.APP_PERMISSIONS
import app.morphe.patches.shared.misc.gms.Constants.GMS_AUTHORITIES
import app.morphe.patches.shared.misc.gms.Constants.GMS_PERMISSIONS
...
fun gmsCoreSupportPatch(
    ...
    val gmsCoreVendorGroupIdOption = stringOption(
        key = "GmsCore vendor group ID",
        default = "app.rivanced",
        values = mapOf("MicroG GmsCore" to "app.rivanced"),
        ...
        document("AndroidManifest.xml").use { document ->
            ...
            applicationNode.appendChild(
                document.createElement("meta-data").apply {
                    ...
                    setAttribute("android:name", "app.rivanced.MICROG_PACKAGE_NAME")
