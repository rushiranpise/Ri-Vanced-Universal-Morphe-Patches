...
private const val LAUNCHER_RESOURCE_NAME_PREFIX = "rivanced_launcher_"
private const val LAUNCHER_ADAPTIVE_BACKGROUND_PREFIX = "rivanced_adaptive_background_"
private const val LAUNCHER_ADAPTIVE_FOREGROUND_PREFIX = "rivanced_adaptive_foreground_"
private const val LAUNCHER_ADAPTIVE_MONOCHROME_PREFIX = "rivanced_adaptive_monochrome_"
private const val NOTIFICATION_ICON_NAME = "rivanced_notification_icon"
...
internal fun baseCustomBrandingPatch(
            ...
            document("AndroidManifest.xml").use { document ->
                ...
                application.setAttribute(
                    ...
                    if (useCustomName) {
                        ...
                        "@string/rivanced_custom_branding_name_entry_2"
                    }
                )
            }
        }
    ...
    execute {
        ...
        preferenceScreen.addPreferences(
            if (useCustomName) {
                ListPreference(
                    key = "rivanced_custom_branding_name",
                    entriesKey = "rivanced_custom_branding_name_custom_entries",
                    entryValuesKey = "rivanced_custom_branding_name_custom_entry_values",
                )
            } else {
                ListPreference("rivanced_custom_branding_name")
            },
            if (useCustomIcon) {
                ListPreference(
                    key = "rivanced_custom_branding_icon",
                    entriesKey = "rivanced_custom_branding_icon_custom_entries",
                    entryValuesKey = "rivanced_custom_branding_icon_custom_entry_values",
                )
            } else {
                ListPreference("rivanced_custom_branding_icon")
            },
        )
        ...
        document("AndroidManifest.xml").use { document ->
            ...
            fun createAlias(
                ...
                val label = if (useCustomName) {
                    ...
                    "@string/rivanced_custom_branding_name_entry_$appNameIndex"
                }
            ...
            if (useCustomIcon) {
                application.setAttribute(
                    "android:icon",
                    "@mipmap/rivanced_launcher_custom"
                )
            }
            ...
            for (appNameIndex in 1..numberOfPresetAppNames) {
                fun aliasName(name: String): String = ".rivanced_" + name + '_' + appNameIndex
