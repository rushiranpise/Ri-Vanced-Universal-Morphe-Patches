...
public class CustomDialogListPreference extends ListPreference {
    ...
    public static final int ID_RIVANCED_CHECK_ICON = getResourceIdentifierOrThrow(
            ResourceType.ID, "rivanced_check_icon");
    public static final int ID_RIVANCED_CHECK_ICON_PLACEHOLDER = getResourceIdentifierOrThrow(
            ResourceType.ID, "rivanced_check_icon_placeholder");
    public static final int ID_RIVANCED_ITEM_TEXT = getResourceIdentifierOrThrow(
            ResourceType.ID, "rivanced_item_text");
    public static final int LAYOUT_RIVANCED_CUSTOM_LIST_ITEM_CHECKED = getResourceIdentifierOrThrow(
            ResourceType.LAYOUT, "rivanced_custom_list_item_checked");
    public static final int DRAWABLE_CHECKMARK = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "rivanced_settings_custom_checkmark");
    public static final int DRAWABLE_CHECKMARK_BOLD = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "rivanced_settings_custom_checkmark_bold");
    ...
    public static class ListPreferenceArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder.placeholder = view.findViewById(ID_RIVANCED_CHECK_ICON_PLACEHOLDER);
                holder.itemText = view.findViewById(ID_RIVANCED_ITEM_TEXT);
                holder.checkIcon = view.findViewById(ID_RIVANCED_CHECK_ICON);
    ...
    protected void showDialog(Bundle state) {
        ...
        ListPreferenceArrayAdapter adapter = new ListPreferenceArrayAdapter(
                context,
                LAYOUT_RIVANCED_CUSTOM_LIST_ITEM_CHECKED,
                entriesToShow,
                entryValues,
                getValue()
        );
