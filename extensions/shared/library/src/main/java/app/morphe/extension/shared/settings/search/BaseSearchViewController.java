...
/**
 * Abstract controller for managing the overlay search view in RIVanced settings.
...
public abstract class BaseSearchViewController {
    ...
    protected static final int ID_RIVANCED_SEARCH_VIEW = getResourceIdentifierOrThrow(
            ResourceType.ID, "rivanced_search_view");
    protected static final int ID_RIVANCED_SEARCH_VIEW_CONTAINER = getResourceIdentifierOrThrow(
            ResourceType.ID, "rivanced_search_view_container");
    protected static final int ID_ACTION_SEARCH = getResourceIdentifierOrThrow(
            ResourceType.ID, "action_search");
    protected static final int ID_RIVANCED_SETTINGS_FRAGMENTS = getResourceIdentifierOrThrow(
            ResourceType.ID, "rivanced_settings_fragments");
    private static final int DRAWABLE_RIVANCED_SETTINGS_SEARCH_ICON = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "rivanced_settings_search_icon");
    private static final int DRAWABLE_RIVANCED_SETTINGS_SEARCH_ICON_BOLD = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "rivanced_settings_search_icon_bold");
    protected static final int MENU_RIVANCED_SEARCH_MENU = getResourceIdentifierOrThrow(
            ResourceType.MENU, "rivanced_search_menu");

    /**
     * @return The search icon, either bold or not bold, depending on the RIVanced UI setting.
     */
    public static int getSearchIcon() {
        return Utils.appIsUsingBoldIcons()
                ? DRAWABLE_RIVANCED_SETTINGS_SEARCH_ICON_BOLD
                : DRAWABLE_RIVANCED_SETTINGS_SEARCH_ICON;
    }
    ...
    private void initializeSearchView() {
        ...
        searchView = activity.findViewById(ID_RIVANCED_SEARCH_VIEW);
        ...
        searchContainer = activity.findViewById(ID_RIVANCED_SEARCH_VIEW_CONTAINER);

        // Set background and query hint.
        searchView.setBackground(createBackgroundDrawable());
        searchView.setQueryHint(str("rivanced_settings_search_hint"));
        ...
        AppLanguage appLanguage = BaseSettings.RIVANCED_LANGUAGE.get();
    ...
    private void initializeOverlayContainer() {
        ...
        FrameLayout mainContainer = activity.findViewById(ID_RIVANCED_SETTINGS_FRAGMENTS);
    ...
    protected void setupToolbarMenu() {
        toolbar.inflateMenu(MENU_RIVANCED_SEARCH_MENU);
    ...
    protected void filterAndShowResults(String query) {
        ...
        if (filteredSearchItems.isEmpty()) {
            ...
            noResultsPreference.setTitle(str("rivanced_settings_search_no_results_title", query));
            noResultsPreference.setSummary(str("rivanced_settings_search_no_results_summary"));
