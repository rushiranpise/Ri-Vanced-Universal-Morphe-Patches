...
public abstract class BaseSearchResultItem {
    ...
    public enum ViewType {
        ...
        public int getLayoutResourceId() {
            return switch (this) {
                case REGULAR, URL_LINK ->   getResourceIdentifier("rivanced_preference_search_result_regular");
                case SWITCH ->              getResourceIdentifier("rivanced_preference_search_result_switch");
                case LIST   ->              getResourceIdentifier("rivanced_preference_search_result_list");
                case COLOR_PICKER ->        getResourceIdentifier("rivanced_preference_search_result_color");
                case GROUP_HEADER ->        getResourceIdentifier("rivanced_preference_search_result_group_header");
                case NO_RESULTS   ->        getResourceIdentifier("rivanced_preference_search_no_result");
            };
        }
    ...
    public static class PreferenceSearchItem extends BaseSearchResultItem {
        ...
        private String buildSearchableText(Preference pref) {
            ...
            if (key != null) {
                // Normalize preference key by removing the common "rivanced_" prefix
                // so that users can search by the meaningful part only.
                normalizedKey = key.startsWith("rivanced_")
                        ? key.substring("rivanced_".length())
                        : key;
            }
