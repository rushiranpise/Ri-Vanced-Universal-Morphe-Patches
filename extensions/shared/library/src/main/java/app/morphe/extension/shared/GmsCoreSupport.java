...
public class GmsCoreSupport {
    ...
    private static String getGmsCoreVendorGroupId() {
        return "app.rivanced"; // Modified during patching.
    }
    ...
    private enum GmsCore {
        RIVANCED("app.rivanced", "https://github.com/rivanced/gmscore/releases/latest", () -> {
            try {
                HttpURLConnection connection = Requester.getConnectionFromRoute(
                        "https://api.github.com",
                        new Route(GET, "/repos/rivanced/gmscore/releases/latest")
                );
        ...
        private void checkInstallation(Activity context) {
            try {
                ...
                try {
                    ...
                    Utils.showToastLong(str("rivanced_gms_core_toast_not_installed_message"));
                ...
                if (isAndroidAutomotive(context)) {
                    ...
                    showBatteryOptimizationDialog(context,
                            "rivanced_gms_core_dialog_not_whitelisted_using_battery_optimizations_message",
                            "rivanced_gms_core_dialog_continue_text",
                ...
                try {
                    if (client == null) {
                        ...
                        showBatteryOptimizationDialog(context,
                                "rivanced_gms_core_dialog_not_whitelisted_not_allowed_in_background_message",
                                "gmsrivanced_gms_core_log_open_website_text",
            ...
            Utils.runOnBackgroundThread(() -> {
                try {
                    ...
                    if (latestVersion == null || latestVersion.isEmpty()) {
                        ...
                        Utils.showToastLong(str("rivanced_gms_core_toast_update_check_failed_message"));
                        return;
                    }
            ...
            Utils.runOnMainThreadDelayed(() -> {
                try {
                    Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                            context,
                            str("rivanced_gms_core_dialog_title"),
                            String.format(str("rivanced_gms_core_update_available_message"), latestVersion, installedVersion),
                            null,
                            str("rivanced_gms_core_dialog_open_website_text"),
                            () -> open(downloadQuery),
                            () -> {
                            },
                            str("rivanced_gms_core_dialog_cancel_text"),
                            null,
                            true
                    );
        ...
        private static void showBatteryOptimizationDialog(Activity context,
            ...
            Utils.runOnMainThreadDelayed(() -> {
                ...
                Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                        context,
                        str("rivanced_gms_core_dialog_title"), // Title.
