...
/**
 * RIVanced specific logger. Logging is done to standard device log (accessible through ADB),
...
public class Logger {
     ...
     */
    private static final String RIVANCED_LOG_TAG_PREFIX = "rivanced: ";
     ...
     * with class name but without 'rivanced:' prefix.
     *
