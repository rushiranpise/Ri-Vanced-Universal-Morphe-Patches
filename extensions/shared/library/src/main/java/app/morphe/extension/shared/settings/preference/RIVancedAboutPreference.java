...
public class RIVancedAboutPreference extends Preference {
    ...
    private String createDialogHtml(WebLink[] aboutLinks) {
        ...
        builder.append("<p>")
                ...
                .append(useNonBreakingHyphens(getString("rivanced_settings_about_links_body", patchesVersion)))
                .append("</p>");
        ...
        if (patchesVersion.contains("dev")) {
            builder.append("<h3>")
                    ...
                    .append(useNonBreakingHyphens(getString("rivanced_settings_about_links_dev_header")))
                    .append("</h3>");

            builder.append("<p>")
                    .append(getString("rivanced_settings_about_links_dev_body"))
                    .append("</p>");
        }

        builder.append("<h2 style=\"margin-top: 30px;\">")
                .append(getString("rivanced_settings_about_links_header"))
                .append("</h2>");
    ...
    public RIVancedAboutPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }
    public RIVancedAboutPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public RIVancedAboutPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public RIVancedAboutPreference(Context context) {
        super(context);
    }
}
