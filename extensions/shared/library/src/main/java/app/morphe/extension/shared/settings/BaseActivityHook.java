...
public abstract class BaseActivityHook extends Activity {
    ...
    private static final int ID_RIVANCED_SETTINGS_FRAGMENTS =
            getResourceIdentifierOrThrow(ResourceType.ID, "rivanced_settings_fragments");
    private static final int ID_RIVANCED_TOOLBAR_PARENT =
            getResourceIdentifierOrThrow(ResourceType.ID, "rivanced_toolbar_parent");
    public static final int LAYOUT_RIVANCED_SETTINGS_WITH_TOOLBAR =
            getResourceIdentifierOrThrow(ResourceType.LAYOUT, "rivanced_settings_with_toolbar");
    private static final int STRING_RIVANCED_SETTINGS_TITLE =
            getResourceIdentifierOrThrow(ResourceType.STRING, "rivanced_settings_title");
    ...
    public static void initialize(BaseActivityHook hook, Activity activity) {
        try {
            ...
            if (!"rivanced_settings_intent".equals(dataString)) {
            ...
            activity.getFragmentManager()
                    .beginTransaction()
                    .replace(ID_RIVANCED_SETTINGS_FRAGMENTS, fragment)
                    .commit();
        } catch (Exception ex) {
    ...
    /**
     * Injection point.
     * Overrides the RIVanced settings language.
     */
    @SuppressWarnings("unused")
    public static Context getAttachBaseContext(Context original) {
        AppLanguage language = BaseSettings.RIVANCED_LANGUAGE.get();
    ...
    protected void createToolbar(Activity activity, PreferenceFragment fragment) {
        ...
        ViewGroup toolbarParent = activity.findViewById(ID_RIVANCED_TOOLBAR_PARENT);
        ViewGroup dummyToolbar = Utils.getChildViewByResourceName(toolbarParent, "rivanced_toolbar");
        ...
        toolbar.setTitle(STRING_RIVANCED_SETTINGS_TITLE);
    ...
    protected int getContentViewResourceId() {
        return LAYOUT_RIVANCED_SETTINGS_WITH_TOOLBAR;
    }
