...
public final class CheckEnvironmentPatch {
    ...
    private enum InstallationType {
        ...
        MANAGER("app.rivanced.manager.flutter",
                "app.rivanced.manager.flutter.debug",
                "app.rivanced.manager",
                "app.rivanced.manager.debug");
    ...
    private static class CheckExpectedInstaller extends Check {
        ...
        protected String failureReason() {
            return str("rivanced_check_environment_manager_not_expected_installer");
        }
    ...
    private static class CheckWasPatchedOnSameDevice extends Check {
        ...
        @Override
        protected String failureReason() {
            return str("rivanced_check_environment_not_same_patching_device");
        }
    ...
    private static class CheckIsNearPatchTime extends Check {
        ...
        protected String failureReason() {
            if (durationBetweenPatchingAndInstallation < 0) {
                ...
                return str("rivanced_check_environment_not_near_patch_time_invalid");
            }
            ...
            if (daysSincePatching > 1) { // Use over 1 day to avoid singular vs plural strings.
                return str("rivanced_check_environment_not_near_patch_time_days", daysSincePatching);
            }

            return str("rivanced_check_environment_not_near_patch_time");
        }
